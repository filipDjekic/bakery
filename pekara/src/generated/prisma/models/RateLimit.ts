...
export type RateLimitModel =
  runtime.Types.Result.DefaultSelection<Prisma.$RateLimitPayload>;
...
> = {
   ...
   */
  orderBy?:
    | Prisma.RateLimitOrderByWithRelationInput
    | Prisma.RateLimitOrderByWithRelationInput[];
  /**
...
> = {
  where?: Prisma.RateLimitWhereInput;
  orderBy?:
    | Prisma.RateLimitOrderByWithAggregationInput
    | Prisma.RateLimitOrderByWithAggregationInput[];
...
export type GetRateLimitGroupByPayload<T extends RateLimitGroupByArgs> =
...
export type RateLimitScalarWhereWithAggregatesInput = {
  ...
  lastRequest?:
    Prisma.BigIntWithAggregatesFilter<'RateLimit'> | bigint | number;
};
...
export type RateLimitGetPayload<
  S extends boolean | null | undefined | RateLimitDefaultArgs,
...
> {
  ...
  >(
    args: Prisma.SubsetIntersection<T, RateLimitGroupByArgs, OrderByArg> &
      InputErrors,
  ): {} extends InputErrors
    ? GetRateLimitGroupByPayload<T>
...
> = {
   ...
   */
  distinct?:
    Prisma.RateLimitScalarFieldEnum | Prisma.RateLimitScalarFieldEnum[];
};
...
> = {
   ...
   */
  data: Prisma.XOR<
    Prisma.RateLimitUpdateInput,
    Prisma.RateLimitUncheckedUpdateInput
  >;
  /**
